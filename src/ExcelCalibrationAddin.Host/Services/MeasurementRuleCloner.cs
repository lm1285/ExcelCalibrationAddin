...
{
    public static class MeasurementRuleCloner
    {
        public static MeasurementRule Clone(MeasurementRule rule)
        {
            if (rule == null)
            {
                return null;
        ...
        private static FormatRule CloneFormatRule(FormatRule value)
        {
            if (value == null)
            {
                return null;
            ...
            return new FormatRule
            {
                ...
                IsScientificNotation = value.IsScientificNotation,
                IsPercentage = value.IsPercentage,
                UnitSuffix = value.UnitSuffix,
                RawNumberFormat = value.RawNumberFormat
            };
        }
